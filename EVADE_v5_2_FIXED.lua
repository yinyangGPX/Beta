...
TabMovimiento:CreateButton("MOVIMIENTO AVANZADO", function() end)
...
TabMovimiento:CreateButton("Velocidad recomendada: 10-30", function() end)
...
TabMovimiento:CreateButton("Altura recomendada: 50-100", function() end)
...
TabMovimiento:CreateButton("Salta automáticamente al correr", function() end)
...
TabMovimiento:CreateButton("Salta + velocidad hacia adelante", function() end)
TabMovimiento:CreateButton("Controlable con WASD", function() end)
...
TabMovimiento:CreateButton("Causa lag 0.5s cada activación", function() end)
TabMovimiento:CreateButton("Presiona [E] para activar", function() end)

-- 
-- PESTAÑA CRÉDITOS
-- 

TabCreditos:CreateButton("INFORMACIÓN", function() end)

TabCreditos:CreateButton("EVADE v5.2 BETA", function() end)
TabCreditos:CreateButton("Creador: MOFUZII", function() end)
TabCreditos:CreateButton("Conectado a: Yin Yang v27 FINAL", function() end)
TabCreditos:CreateButton("© Todos los derechos reservados 2024", function() end)
