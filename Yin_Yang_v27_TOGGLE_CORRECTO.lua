...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    function Window:CreateTab(name, iconAsset)
        ...
        function Tab:CreateFloatingToggleSimple(text, default, callback)
            ...
            --// FRAME PRINCIPAL (Tamaño correcto: 260x60)
            local FloatingWindow = mk("Frame", {
                Name = "FloatingToggle_" .. text,
            ...
            --// ESQUINAS REDONDEADAS (Radio 28 para cápsula elegante)
            corner(FloatingWindow, 28)
            
            --// BORDE SUAVE Y ELEGANTE
            stroke(FloatingWindow, Theme.Accent, 2, 0.5)
            
            --// UIListLayout PARA ALINEACIÓN HORIZONTAL
            ...
            local ControlsContainer = mk("Frame", {
                Size = UDim2.new(0, 110, 1, 0),
                BackgroundTransparency = 1,
                ZIndex = 151,
                LayoutOrder = 2,
            ...
            --// BOTÓN + (Más)
            local PlusButton = mk("TextButton", {
            ...
            --// BOTÓN - (Menos)
            local MinusButton = mk("TextButton", {
                Size = UDim2.new(0, 28, 0, 28),
                BackgroundColor3 = Theme.Accent,
                Text = "-",
                TextColor3 = Color3.fromRGB(255, 255, 255),
            ...
            --// SWITCH/TOGGLE (55x28)
            local SwitchContainer = mk("Frame", {
            ...
            corner(SwitchContainer, 14)
            
            --// KNOB DEL SWITCH (24x24)
            local Knob = mk("Frame", {
                Size = UDim2.new(0, 24, 0, 24),
            ...
            --// CLICK EN SWITCH
            local SwitchButton = mk("TextButton", {
                Size = UDim2.new(1, 0, 1, 0),
                BackgroundTransparency = 1,
                Text = "",
                ZIndex = 153,
            ...
            track(SwitchButton.MouseButton1Click:Connect(function()
                state = not state
                updateSwitch()
