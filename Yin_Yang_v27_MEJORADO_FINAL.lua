...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    function Window:SetTheme(themeName)
        ...
        --// Actualizar imagen de fondo - ACCESO CORRECTO
        pcall(function()
            if self.BackgroundArt and self.BackgroundArt.Parent then
                self.BackgroundArt.Image = ThemeBackgroundImages[themeName] or ""
                print("✅ Imagen de fondo actualizada al tema: " .. themeName)
            else
                print("⚠️ BackgroundArt no encontrado")
            end
        end)
