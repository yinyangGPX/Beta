        ...
        function Tab:CreateFloatingToggle(text, default, callback)
            ...
            local function createFloatingWindow()
                ...
                FloatClick.MouseButton1Click:Connect(function()
                    ...
                    --// Tween 3: Glow (Fade in/out)
                    TweenService:Create(FloatingGlow, TweenInfo.new(0.15), 
                        {BackgroundTransparency = state and 0.5 or 0.7}):Play()
    ...
    function Window:SetTheme(themeName)
        ...
        pcall(function()
            if BackgroundArt and BackgroundArt.Parent then
                ...
                print("✅ Imagen de fondo actualizada: " .. themeName)
            end
        end)
        
        --// Actualizar colores de FloatingToggles
        pcall(function()
            if Window.FloatingToggles then
                for _, floatingData in ipairs(Window.FloatingToggles) do
                    if floatingData.Window and floatingData.Window.Parent then
                        floatingData.Window.BackgroundColor3 = Theme.Secondary
                        floatingData.Window.BackgroundTransparency = 0.35
                        for _, child in ipairs(floatingData.Window:GetChildren()) do
