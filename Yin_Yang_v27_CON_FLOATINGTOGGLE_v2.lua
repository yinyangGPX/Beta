    ...
    function Window:CreateTab(name, iconAsset)
        ...
        function Tab:CreateFloatingToggle(text, default, callback)
            ...
            local function createFloatingWindow()
                ...
                --// GLOW EXTERIOR (Efecto brillo suave)
                FloatingGlow = mk("Frame", {
                    Parent = Window.ScreenGui,
                    Size = UDim2.fromOffset(260 + 16, 58 + 16),
                    Position = UDim2.new(0.5, -138, 0.5, -45),
                ...
                --// VENTANA PRINCIPAL (Cápsula elegante)
                FloatingWindow = mk("Frame", {
                    Parent = Window.ScreenGui,
                    Size = UDim2.fromOffset(260, 58),
                    Position = UDim2.new(0.5, -130, 0.5, -29),
                    BackgroundColor3 = Color3.fromRGB(20, 20, 25),  -- Glass oscuro
                ...
                --// Borde cian fino
                stroke(FloatingWindow, Color3.fromRGB(100, 200, 255), 2, 0.8)
                ...
                --// TEXTO (Centrado verticalmente, GothamBold)
